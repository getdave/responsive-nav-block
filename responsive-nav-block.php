...
function sidebar_plugin_register() {
	...
	$manifest = require 'build/index.asset.php';
...
function getdave_responsive_nav_block_editor_assets() {
	wp_enqueue_script( 'getdave-responsive-nav-block-js' );

}
	add_action( 'enqueue_block_editor_assets', 'getdave_responsive_nav_block_editor_assets' );

function getdave_responsive_nav_block_assets() {
	// wp_enqueue_style( 'getdave-responsive-nav-block-css' );
}
	add_action( 'enqueue_block_assets', 'getdave_responsive_nav_block_assets' );
